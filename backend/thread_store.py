...
def save_turn(thread_id: str, user_input: str, response_data: Dict[str, Any], images: Optional[List[str]] = None):
    """
    ...
    save_user_message(thread_id, user_input, user_msg_id=user_msg_id, timestamp_str=time_str, images=images)
